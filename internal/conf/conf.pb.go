...
type Server struct {
	...
	Rpcx *Server_RPCX `protobuf:"bytes,3,opt,name=rpcx,proto3" json:"rpcx,omitempty"`
}
...
func (x *Server) GetRpcx() *Server_RPCX {
	if x != nil {
		return x.Rpcx
	}
	return nil
...
func (x *Server_RPCX) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_RPCX) ProtoMessage() {}

func (x *Server_RPCX) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_RPCX.ProtoReflect.Descriptor instead.
func (*Server_RPCX) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_RPCX) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Server_RPCX) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_RPCX) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd0, 0x03, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x47, 0x52, 0x50, 0x43, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x12, 0x2b, 0x0a, 0x04, 0x72, 0x70,
	0x63, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f,
	0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x52, 0x50, 0x43,
	0x58, 0x52, 0x04, 0x72, 0x70, 0x63, 0x78, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12,
	...
	0x04, 0x52, 0x50, 0x43, 0x58, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x79, 0x6b, 0x69, 0x72, 0x61, 0x2f, 0x6b, 0x72,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_RPCX)(nil),         // 5: kratos.api.Server.RPCX
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.rpcx:type_name -> kratos.api.Server.RPCX
	...
	8,  // 9: kratos.api.Server.RPCX.timeout:type_name -> google.protobuf.Duration
